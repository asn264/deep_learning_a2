...
$$E[x_1,...,x_n] = \frac{1}{n} \sum_{i=1}^n \hat{x_i} = \frac{1}{n} \sum_{i=1}^n \frac{x_i - \mu_n}{\sigma_n} 
= \frac{1}{n \sigma_n} \sum_{i=1}^n (x_i - \mu_n) $$
$$ =  \frac{1}{n \sigma_n}  \Bigg[ \Bigg( \sum_{i=1}^n x_i \Bigg) - n \cdot \mu_n    \Bigg]
=  \frac{1}{n \sigma_n}  \Bigg[ \sum_{i=1}^n x_i  - \sum_{i=1}^n x_i  \Bigg] = 0$$
\newline
\newline
